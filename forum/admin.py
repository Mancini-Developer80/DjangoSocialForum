...
"""
Personalizzare i dati che vengono visualizzati nel 
pannello admin
...
admin.site.register(Discussione, DiscussioneModelAdmin) # Includere le personalizzazione del pannello Admin
